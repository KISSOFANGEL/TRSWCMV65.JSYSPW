var IMG_SRC_PREX = "../images/tree/auth/";
...
var TREE_ICON_RES = {
    ...
    'icon_32' : IMG_SRC_PREX + 'trstree_base.gif',   // root leaf icon normal
	...
	'icon_56' : IMG_SRC_PREX + 'trstree_base.gif',   // root icon opened
	...
	'icon_24' : IMG_SRC_PREX + 'trstree_folderopen.gif', // node icon opened
	...
	'icon_n_U0'	  : IMG_SRC_PREX + 'trstree_user.gif',      // 用户管理
		'icon_n_U00'	  : IMG_SRC_PREX + 'trstree_usernew.gif',          // 待开通
		'icon_n_U030'	  : IMG_SRC_PREX + 'trstree_usernormal.gif',       // 已开通
		'icon_n_U020'	  : IMG_SRC_PREX + 'trstree_userforbiden.gif',     // 已禁止
		'icon_n_U010'	  : IMG_SRC_PREX + 'trstree_userdeleted.gif',      // 已删除

	'icon_n_0'   : IMG_SRC_PREX + 'trstree_auth_root.gif'
};
