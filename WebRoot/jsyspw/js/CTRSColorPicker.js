...
*/
	...
	var sColor = 
	showModalDialog('../js/color_select/colordialog.html', args,'status:no;dialogWidth:370px;dialogHeight:240px') 
...
function CTRSColorPicker_create(_sElName, _sInitColor){
	...
	var sHTML = ""
			...
			+"<TR><TD><IMG SRC=\"../images/icon_colorpicker.gif\" WIDTH=\"16\" HEIGHT=\"12\" alt=\"设定标题颜色\" onclick=\"TRSColorPicker.openPicker('"+_sElName+"');\"></TD></TR>"
