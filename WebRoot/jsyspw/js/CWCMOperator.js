...
function CWCMOperatorHelper_getObjTitle(){
	switch(this.currOperator.ObjType){
		case TYPE_WCMOBJ_USER:
			return "<IMG src=\"../images/icon_user.gif\" width=\"16\" height=\"16\">[<font color=blue>"+this.currOperator.ObjName+"</font>]";
		case TYPE_WCMOBJ_GROUP:
			return "<IMG src=\"../images/icon_group.gif\" width=\"16\" height=\"16\">[<font color=blue>"+this.currOperator.ObjName+"</font>]";
		case TYPE_WCMOBJ_ROLE:
			return "<IMG src=\"../images/icon_role.gif\" width=\"16\" height=\"16\">[<font color=blue>"+this.currOperator.ObjName+"</font>]";
		default:
...
function CWCMOperatorHelper_addNode(){
	var oTR = this.oParentTable.insertRow();
	...
	oTD.align = "center";
	oTD.innerHTML = "<A onclick=\"WCMOperatorHelper.removeOperator("+this.currOperator.ObjType+", "+this.currOperator.ObjId+");WCMOperatorHelper.notifyTop("+this.currOperator.ObjType+", "+this.currOperator.ObjId+")\" href=\"#\"><IMG src=\"../images/button_delete.gif\" border=\"0\" width=\"16\" height=\"16\"></A>";
}
...
function CWCMOperatorHelper_removeOperator(_nType, _nId, _sName){
	...
	var oNode = document.all(this.currOperator.getKey());
...
function CWCMOperatorHelper(){
	...
	this.oParentTable = document.all(PARENT_TABLE_NAME);
