...
{"ItemText" : "<%=LocaleServer.getString("system.button.add", "采集")%>",			"ItemId" : "addnew",	"ItemAction" : "addeditInfoViewDocument();",		"ItemParent" : null, "RightIndex" : 31},
...
{"ItemText" : "<%=LocaleServer.getString("system.label.edit", "编辑")%>",
"ItemId" : "editdoc",		"ItemAction" : "addeditInfoViewDocument(m_objSrcEl.DocumentId);",					"ItemParent" : null, "RightIndex" : 32},
...
{"ItemText" : "<%=LocaleServer.getString("document.label.rightset", "设置权限")%>",					"ItemId" : "setRight",		"ItemAction" : "dowithRight(m_objSrcEl.DocumentId);",					"ItemParent" : null, "RightIndex" : 54},
...
document.write('<script type="text/javascript" src="../infoview/prototype.js"></script>');
document.write('<script type="text/javascript" src="../js/InfoviewDocumentPosition.js"></script>');
