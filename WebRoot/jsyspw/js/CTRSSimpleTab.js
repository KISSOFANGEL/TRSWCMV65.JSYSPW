...
*/
	...
	var sHTML = ""
			...
			+" <!--~--- ROW4 ---~-->" 
			+" <TR>" 
			+"	<TD width=\"4\"><IMG src=\"../images/tab2_left"+sImgAfter+".gif\" width=\"4\" height=\"27\"></TD>			" 
			+"	<TD width=\""+nWidth+"\" background=\"../images/tab2_bg"+sImgAfter+".gif\" align=center nowrap>";
			if (this.bDisabled)
			{
			...
			sHTML = sHTML
			+" </TD>" 
			+"	<TD width=\"4\"><IMG src=\"../images/tab2_right"+sImgAfter+".gif\" width=\"4\" height=\"27\"></TD>" 
			+" </TR>" 
			+" <!--~- END ROW4 -~-->" 
			+"</TABLE>" 
			+"</TD>"
			+"<TD "+sSeperateTdWidth+" BACKGROUND=\"../images/tab2_m.gif\" align=right>&nbsp;</TD>";
